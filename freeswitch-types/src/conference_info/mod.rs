...
mod tests {
    ...
    mod xml {
        ...
        fn parse_prefixed_production_xml() {
            ...
            assert_eq!(
                doc.entity,
                "sip:844c390d67e44b309e02e5b78bda695f@focus.qc.core.ng.example.com"
            );
            assert_eq!(doc.state, Some(State::Full));
            ...
            assert_eq!(
                host.display_text
                    .as_deref(),
                Some("sip:conf1.conf1.qc.lsrg@lsrg.qc.core.ng.example.com")
            );
            let host_uris = host
                .uris
                .as_ref()
            ...
            assert_eq!(psap.entity, "sip:1251@user1.qc.psap.ng.example.com");
            assert_eq!(
                psap.endpoints
                    .len(),
                1
